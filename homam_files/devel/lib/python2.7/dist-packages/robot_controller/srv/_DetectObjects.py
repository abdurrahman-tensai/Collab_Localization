...
"""autogenerated by genpy from robot_controller/DetectObjectsRequest.msg. Do not edit."""
import codecs
import sys
...
class DetectObjectsRequest(genpy.Message):
  ...
  _type = "robot_controller/DetectObjectsRequest"
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robot_controller/DetectObjectsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
import robot_controller.msg

class DetectObjectsResponse(genpy.Message):
  _md5sum = "832bf2ae172cf259fafc45005d594984"
  _type = "robot_controller/DetectObjectsResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """DetectedObject object
...
"""
  __slots__ = ['object']
  _slot_types = ['robot_controller/DetectedObject']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.object is None:
        self.object = robot_controller.msg.DetectedObject()
    else:
      self.object = robot_controller.msg.DetectedObject()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4i().pack(_x.object.x1, _x.object.y1, _x.object.x2, _x.object.y2))
      _x = self.object.class_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.object.x1, _x.object.y1, _x.object.x2, _x.object.y2,) = _get_struct_4i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.object.class_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.object.class_name = str[start:end]
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class DetectObjects(object):
  _type          = 'robot_controller/DetectObjects'
  _md5sum = '66b6b06f35191dce919e07c706baac8b'
